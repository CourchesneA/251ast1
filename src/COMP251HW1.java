...
public class COMP251HW1 {
	...
	public double divisionMethodImpl (int r, int n, int w) {
		...
		//Idea: I will generate a key, use the division hash function to map it to a new value, and add that value
	...
	/**
	 * Separate division hash function to make code cleaner
	 * @param k, key to hash
	 * @param r
	 * @return
	 */
